      ...
      <div class="card">
        ...
        <div class="card-primary card-outline">
          ...
          <div class="sub-main-w3">
            <form action="editsp" method="get">
              <div class="form-style-agile">
                <label>ID</label>
                <div class="pom-agile">
                  <input name="id" type="text" value="${detail.ID}" required="">
              ...
              <div class="form-style-agile">
                ...
                <div class="pom-agile">
                  <input name="name" type="text" value="${detail.name}" required="">
              ...
              <div class="form-style-agile">
                <label>Giá</label>
                <div class="pom-agile">
                  <input value="${detail.price}" name="gia" type="text" id="gia" required="">
              ...
              <div class="form-style-agile">
                ...
                <div class="pom-agile">
                  <input value="${detail.img}" name="img" type="text" required="">
              ...
              <div class="form-style-agile">
                ...
                <label>Mô tả</label>
                <div class="pom-agile">
                    <textarea  name="mota" type="text" required="'" >${detail.description}
                ...
                <div class="card-footer">
                  <div class="float-right">
                    ...
                    <button type="submit" class="btn btn-primary" value="editsp"><i class="fas fa-plus-circle"></i> Luu</button>
                  </div>
