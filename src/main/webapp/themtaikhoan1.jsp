      ...
      <div class="card">
        ...
        <div class="card-primary card-outline">
          <div class="card-header">
            <h3 class="card-title">Nhập thông tin tài khoản mới</h3>
          </div>


          <div class="sub-main-w3">
            <form action="addUserad" method="get">
            ...
            <div class="float-right">
              ...
              <button type="submit" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Thêm </button>
            </div>
